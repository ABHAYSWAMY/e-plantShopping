...
function ProductList({ onHomeClick }) {
    ...
    // Remove local addedToCart state, use Redux cart state instead
    ...
    const allPlants = plantsArray.flatMap(categoryObj => categoryObj.plants);
    const styleObj = {
                ...
                <div style={styleObjUl}>
                    ...
                    <div style={{ position: 'relative' }}>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart' style={{ display: 'inline-block', position: 'relative' }}>
                                ...
                                <span style={{ position: 'absolute', top: 0, right: 0, background: 'red', color: 'white', borderRadius: '50%', padding: '2px 8px', fontSize: '18px', minWidth: '28px', textAlign: 'center' }}>{totalQuantity}</span>
                            </h1>
                        </a>
                    </div>
                </div>
            ...
            {!showCart ? (
                <div className="product-grid">
                    {allPlants.map((plant, idx) => {
                        // Check if plant is in cart by name
                        const isInCart = cartItems.some(item => item.name === plant.name);
                        return (
                            <div key={plant.name + idx} className="product-card">
